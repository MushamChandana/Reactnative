...
const Powerpass = ({ navigation }) => {

    const list = [
        {
            data: 'What is Rapido Power Pass?'
        },
        {
            data: 'How can I renew my Power pass?'
        },
        {
            data: 'How can I buy a Rapido Power Pass?'
        },
        {
            data: 'How can I Check the status of my Power pass?'
        },
